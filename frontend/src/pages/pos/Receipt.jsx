...
import { PageTitle, Button, Card, Tooltip } from "../../components/ui";
  ...
  return (
    <div>
      <div className="flex justify-between items-start mb-6">
        ...
        <Tooltip text="Print this receipt"><Button variant="outlineBlue" icon={Printer} onClick={() => window.print()}>Print Receipt</Button></Tooltip>
      </div>
