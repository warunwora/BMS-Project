    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="col-span-2 flex flex-col gap-6">
          ...
          <Card title="Asset Selection" action={<Button variant="outlineBlue" icon={Plus}>Add Asset</Button>}>
        ...
        <Card title="Summary & Payment">
          ...
          <Button className="w-full mb-3">Confirm Rental</Button>
