...
import { PageHeader, Button, Card, Field, Input, Select, Plus, Tooltip, MemberSearch, ProductSearch } from "../../components/ui";
          ...
          <Card title="Purchased Items">
            <div className="flex gap-3 mb-5">
              <div className="flex-1">
                <ProductSearch selected={pickedProduct} onSelect={setPickedProduct} categories="beverage,instrument,shuttlecock,racket" />
              </div>
