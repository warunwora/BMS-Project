        ...
        <div className="col-span-2 flex flex-col gap-6">
          <Card title="Rental Info">
            ...
            <div className="grid grid-cols-2 gap-6 mt-2">
              <Info label="Rental Date" value={r.date} />
              <Info label="Return Status" value={r.status} valueClass={r.status === "Returned" ? "text-emerald-600" : "text-amber-600"} />
            </div>
          </Card>
          <Card title="Asset Items">
            ...
            {items.map((item, i) => {
              ...
              return (
                <div key={i} className="grid grid-cols-[1.4fr_1fr_1.2fr_0.8fr_1fr_1fr] gap-x-3 py-4 border-b border-slate-100 text-sm items-center">
